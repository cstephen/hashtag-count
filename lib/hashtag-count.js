...
HashtagCount.prototype.start = function (settings) {
  ...
  if (settings.connectingCb !== undefined) {
    self.connectingCb = settings.connectingCb;
  }

  if (settings.reconnectingCb !== undefined) {
    self.reconnectingCb = settings.reconnectingCb;
  }

  if (settings.connectedCb !== undefined) {
    self.connectedCb = settings.connectedCb;
  }
  ...
  self.stream.on('reconnect', function (err) {
